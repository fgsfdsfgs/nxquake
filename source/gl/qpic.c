...
================
*/
static void QPic32_AlphaFix(qpic32_t *pic) {
...
static void QPic32_MipMap_1D_Even(qpixel32_t *pixels, int length) {
    const byte *in;
    byte *out;
    int i;
...
static void QPic32_MipMap_1D_Odd(qpixel32_t *pixels, int length) {
...
================
*/
static void QPic32_MipMap_EvenEven(qpixel32_t *pixels, int width, int height) {
    int i, j;
    byte *in, *out;
...
================
*/
static void QPic32_MipMap_OddOdd(qpixel32_t *pixels, int width, int height) {
    ...
    for (y = 0; y < height; y++, in += inwidth << 2) {
        ...
        for (x = 0; x < width; x++, in += 8, out += 4) {
            ...
            out[0] = wx0 * wy0 * r0[0] + wx1 * wy0 * r0[4] + wx2 * wy0 * r0[8] + wx0 * wy1 * r1[0] + wx1 * wy1 * r1[4] +
                     wx2 * wy1 * r1[8] + wx0 * wy2 * r2[0] + wx1 * wy2 * r2[4] + wx2 * wy2 * r2[8];
            out[1] = wx0 * wy0 * r0[1] + wx1 * wy0 * r0[5] + wx2 * wy0 * r0[9] + wx0 * wy1 * r1[1] + wx1 * wy1 * r1[5] +
                     wx2 * wy1 * r1[9] + wx0 * wy2 * r2[1] + wx1 * wy2 * r2[5] + wx2 * wy2 * r2[9];
            out[2] = wx0 * wy0 * r0[2] + wx1 * wy0 * r0[6] + wx2 * wy0 * r0[10] + wx0 * wy1 * r1[2] +
                     wx1 * wy1 * r1[6] + wx2 * wy1 * r1[10] + wx0 * wy2 * r2[2] + wx1 * wy2 * r2[6] +
                     wx2 * wy2 * r2[10];
            out[3] = wx0 * wy0 * r0[3] + wx1 * wy0 * r0[7] + wx2 * wy0 * r0[11] + wx0 * wy1 * r1[3] +
                     wx1 * wy1 * r1[7] + wx2 * wy1 * r1[11] + wx0 * wy2 * r2[3] + wx1 * wy2 * r2[7] +
                     wx2 * wy2 * r2[11];
        }
    }
}
...
================
*/
static void QPic32_MipMap_OddEven(qpixel32_t *pixels, int width, int height) {
    const int inwidth = width;
    const byte *in;
    byte *out;
    int x, y;
    ...
    for (y = 0; y < height; y++, in += inwidth << 2) {
        for (x = 0; x < width; x++, in += 8, out += 4) {
            ...
            out[0] = 0.5 * (wx0 * r0[0] + wx1 * r0[4] + wx2 * r0[8] + wx0 * r1[0] + wx1 * r1[4] + wx2 * r1[8]);
            out[1] = 0.5 * (wx0 * r0[1] + wx1 * r0[5] + wx2 * r0[9] + wx0 * r1[1] + wx1 * r1[5] + wx2 * r1[9]);
            out[2] = 0.5 * (wx0 * r0[2] + wx1 * r0[6] + wx2 * r0[10] + wx0 * r1[2] + wx1 * r1[6] + wx2 * r1[10]);
            out[3] = 0.5 * (wx0 * r0[3] + wx1 * r0[7] + wx2 * r0[11] + wx0 * r1[3] + wx1 * r1[7] + wx2 * r1[11]);
        }
    }
}
...
================
*/
static void QPic32_MipMap_EvenOdd(qpixel32_t *pixels, int width, int height) {
    const int inwidth = width;
    const int inheight = height;
    const byte *in;
    byte *out;
    ...
    for (y = 0; y < height; y++, in += inwidth << 2) {
        ...
        for (x = 0; x < width; x++, in += 8, out += 4) {
            ...
            out[0] = 0.5 * (wy0 * ((int)r0[0] + r0[4]) + wy1 * ((int)r1[0] + r1[4]) + wy2 * ((int)r2[0] + r2[4]));
            out[1] = 0.5 * (wy0 * ((int)r0[1] + r0[5]) + wy1 * ((int)r1[1] + r1[5]) + wy2 * ((int)r2[1] + r2[5]));
            out[2] = 0.5 * (wy0 * ((int)r0[2] + r0[6]) + wy1 * ((int)r1[2] + r1[6]) + wy2 * ((int)r2[2] + r2[6]));
            out[3] = 0.5 * (wy0 * ((int)r0[3] + r0[7]) + wy1 * ((int)r1[3] + r1[7]) + wy2 * ((int)r2[3] + r2[7]));
        }
    }
}
...
================
*/
void QPic32_MipMap(qpic32_t *in) {

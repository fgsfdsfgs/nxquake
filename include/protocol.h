...
static inline qboolean Protocol_Known(int version) {
    switch (version) {
...
static inline int max_models(int protocol) {
    switch (protocol) {
        case PROTOCOL_VERSION_NQ:
...
static inline int max_sounds_static(int protocol) {
    switch (protocol) {
        case PROTOCOL_VERSION_NQ:
        case PROTOCOL_VERSION_BJP:
        case PROTOCOL_VERSION_BJP3:
...
static inline int max_sounds_dynamic(int protocol) {
    switch (protocol) {
        case PROTOCOL_VERSION_NQ:
        case PROTOCOL_VERSION_BJP:
            return qmin(256, MAX_SOUNDS);
...
static inline int max_sounds(int p) { return qmax(max_sounds_dynamic(p), max_sounds_static(p)); }

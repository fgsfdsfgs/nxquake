 ...
 * undefined state.
 */
static inline void list_del(struct list *entry) { __list_del(entry->prev, entry->next); }
 ...
 */
static inline int list_empty(struct list *head) { return head->next == head; }
 ...
 */
static inline void list_splice(struct list *new, struct list *head) {
